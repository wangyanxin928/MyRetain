...
var saveAnswer=function(callback){
    ...
    var ajaxobj = {
        itype: "get",
        iname: "client/questionnaireController/submitQuestionnaire"//"client/questionnaireController/saveAnswer"submitQuestionnaire
    };
    var actobj = {//url中需要的key ：authority,project_id，task_id，questionnaire_id,uid,serid,role
        "answer_id": "",
        "user_id": "201707311134",//"用户ID实际参数值",
        "server_id": "",
        "user_role": "校长",//"用户角色实际参数值",//_UserObject.user_role,
        "project_id": "",
        "task_id": "",
        "questionnaire_id": "201707311134",//"问卷ID实际参数值",
        "content": content,//"答案内容实际参数值",//"",//问卷答案
        "page_num": 1
    };
    var layerIndex = layer.load(0, {shade: false});
    getdata(ajaxobj, actobj, function (data) {
